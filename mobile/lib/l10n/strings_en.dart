...
const Map<String, String> stringsEn = {
  ...
  // Plus subscription
  'plus.statusActive': 'Plus is active',
  'plus.statusInactive': 'Plus is inactive',
  'plus.maxIPs': 'IP quota',
  'plus.usedIPCount': 'Authorized IPs',
  'plus.expiry': 'Expires',
  'plus.usedIPs': 'Authorized IPs',
  'plus.viewAllIPs': 'View all ({0})',
  ...
  'plus.appendWhitelist': 'Append all IPs to whitelist',
  'plus.appendConfirmTitle': 'Append to login whitelist',
  'plus.appendConfirmBody': 'Append {0} authorized IPs to login whitelist?',
  'plus.appendSuccess': 'Added {0} IPs to whitelist',
  'plus.appendFailed': 'Failed to update whitelist: {0}',
  ...
  'plus.statusBannerActive': 'Plus activated',
  'plus.statusBannerInactive': 'Plus inactive',
